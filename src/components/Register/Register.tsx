...
export default function Register() {
  ...
  const repeatPasswordLabel = repeatPasswordError?.message
    ? t(repeatPasswordError.message)
  ...
  return (
    <>
      ...
      <Container sx={styles.container}>
        ...
        <FormGroup onSubmit={onSubmit} sx={styles.form}>
          <InputLabel sx={styles.label} error={!!usernameError} htmlFor={`${htmlInputId.username}`}>
            {usernameLabel}
          </InputLabel>
          <OutlinedInput
            ...
            {...register('username')}
          />
          <InputLabel sx={styles.label} error={!!emailError} htmlFor={`${htmlInputId.email}`}>
            {emailLabel}
          </InputLabel>
          <OutlinedInput
            ...
            {...register('email')}
          />
          <InputLabel sx={styles.label} error={!!passwordError} htmlFor={`${htmlInputId.password}`}>
            {passwordLabel}
          </InputLabel>
          <OutlinedInput
          ...
          />
          <Button type="submit" variant="contained" onClick={onSubmit} disabled={isNotValidated}>
            {submitButtonText}
          </Button>
