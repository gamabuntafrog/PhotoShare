...
export default function CreateCollectionModal({
  ...
  const [createCollection, { isLoading: isCollectionCreatingLoading }] =
    extendedCollectionsApi.useCreateCollectionMutation()
  ...
  return (
    <>
      ...
      <Modal
        ...
        sx={styles.backdrop}
      >
        <Container sx={styles.wrapper} maxWidth="tablet">
          {isCollectionCreatingLoading ? // <MiniLoader withMeta/>
          null : (
            <>
              ...
              <form style={styles.form} onSubmit={onSubmit}>
                ...
                <Button type="submit" variant="outlined" sx={styles.submitButton}>
                  {t('submitButton')}
                </Button>
              </form>
            </>
