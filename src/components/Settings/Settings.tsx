      ...
      <Container sx={styles.container}>
        ...
        <Box sx={styles.wrapper}>
          ...
          <Box sx={{ display: 'flex', mt: 2, mb: 4 }}>
            <Button variant="outlined" onClick={() => i18n.changeLanguage('en-US')}>
              {t('chooseEnglish')}
            </Button>
            <Button variant="outlined" sx={{ ml: 2 }} onClick={() => i18n.changeLanguage('uk')}>
              {t('chooseUkrainian')}
            </Button>
          </Box>
          ...
          <List sx={styles.colorsList}>
            {colorsArray.map((color, index) => {
              return (
                <ListItem key={index} sx={styles.colorItem}>
                  <Button
                    variant="contained"
