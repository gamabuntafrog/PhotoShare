...
const UserCollections = React.lazy(
  () => import('./UserProfile/UserProfileComponents/UserCollections')
)
const UserAllowedToViewCollections = React.lazy(
  () => import('./UserProfile/UserProfileComponents/UserAllowedToViewCollections')
)
