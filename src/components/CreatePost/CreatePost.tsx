...
export default function CreatePost() {
  ...
  const willSavedInCollectionTitle =
    userCollections[watch('collectionIdIndex')]?.title || t('selectCollectionButton')
  ...
  const imageLabel = imageError?.message
    ? t(imageError.message)
    : Boolean(imageFile)
    ? t('selectedImageLabel')
    : t('imageLabel')
  ...
  return (
    <>
      <StandardHelmet
        keyOfTitle="createPost"
        options={{ willSavedIn: willSavedInCollectionTitle }}
      />
      <Container sx={styles.createPostContainer}>
